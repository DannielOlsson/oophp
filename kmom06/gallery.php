...
$doco['stylesheets'][] = 'css/figure.css'; 
$doco['stylesheets'][] = 'css/gallery.css'; 
$doco['stylesheets'][] = 'css/breadcrumb.css'; 
...
//
// Prepare content and store it all in variables in the doco container.
//
$breadcrumb = createBreadcrumb($pathToGallery);

$doco['title'] = "Ett galleri";
$doco['header'] = <<<EOD
