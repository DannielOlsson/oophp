...
class CSource {
  ...
  public function GetBreadcrumbFromPath() {
    ...
    foreach($this->breadcrumb as $val) {
      $path .= "$val/";      
      $html .= "<li><a href='?p=source&path={$path}'>{$val}</a>/</li>";
    }
    $html .= "</ul>\n";
